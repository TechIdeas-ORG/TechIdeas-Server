...
INSERT INTO tbMetricas (`fkSensor`, `dateMetrica`, `valMetrica`)
VALUES
    (1, '2023-06-02 00:00:00', 1),
    (1, '2023-06-02 00:00:00', 1),
    (1, '2023-06-02 00:00:00', 1),
    (1, '2023-06-02 00:00:00', 1),
    (1, '2023-06-02 07:00:00', 1),
    (1, '2023-06-02 07:00:00', 1),
    (1, '2023-06-02 07:00:00', 1),
    (1, '2023-06-02 07:00:00', 1),
    (1, '2023-06-02 07:00:00', 1),
...
WHERE idAmbiente = 1 AND dateMetrica >= '2023-05-28' AND dateMetrica <= '2023-06-03'
GROUP BY horario
